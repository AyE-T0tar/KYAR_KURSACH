document.addEventListener('DOMContentLoaded', function() {
  // 1. Загрузка XML через XMLHttpRequest
  loadFlightsData();

  // 2. Обработчик формы поиска (если есть на странице)
  ...
  // 3. Заполнение формы поиска на booking.html
  fillSearchForm();
});
...
/**
 * Загружает данные из XML и отображает их в таблице
 */
...
/**
 * Отображает рейсы в таблице
 * @param {Document} xml - Распарсенный XML-документ
 */
...
/**
 * Загружает fallback-данные, если XML не загрузился
 */
...
/**
 * Сохраняет параметры поиска в sessionStorage
 */
...
/**
 * Заполняет форму поиска на странице booking.html
 */
...
/**
 * Назначает обработчики событий для кнопок и поиска
 */
